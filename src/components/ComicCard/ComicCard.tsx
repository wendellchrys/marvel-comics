...
export const ComicCard = ({ id, title, thumbnail, isFavorited, toggleFavorite }: ComicCardProps) => {
    return (
        <div
            id={`comic-${id}`}
        ...
        >
            ...
            >
                {isFavorited ? <AiFillHeart size={30} className="text-red-500" /> : <AiOutlineHeart size={30} className="text-gray-300" />}
            </button>
            <Image
                width="270"
                height="200"
